...
이 시간의 목표는 1-3주차를 하나의 이야기로 이해하는 것이다. 함께 아직 Docker와 Kubernetes를 자세히 몰라도, 왜 프로세스와 포트부터 시작하는지, 왜 컨테이너를 배우는지, 왜 Kubernetes까지 가는지 연결할 수 있어야 한다.
...
| 11:40-11:47 | 1-3주차 지도 그리기 | 함께 각 주차의 키워드를 서비스 흐름 위에 붙인다. |
