...
| 시간 | 단계 | 진행 |
|---|---|---|
| 10:00-10:08 | 1교시 연결 | 요청이 서버에 들어온 뒤 어떤 부품이 필요한지 생각한다. |
| 10:08-10:22 | 구성요소 | client, API, data, static file을 구분한다. |
| 10:22-10:35 | HTML과 JSON | 사람이 보는 화면과 프로그램이 읽는 데이터 차이를 본다. |
| 10:35-10:45 | 실패 예측 | 부품별 실패 증상을 추정한다. |
| 10:45-10:50 | 정리 | 오후 시연 앱에서 볼 구조를 예고한다. |
