...
| 시간 | 단계 | 진행 |
|---|---|---|
| 16:00-16:08 | 구조도 기준 | 무엇을 그림에 넣을지 정한다. |
| 16:08-16:25 | 개인 구조도 | Day4 시연 앱 구조를 그린다. |
| 16:25-16:38 | 실패 지점 표시 | 404, 500, unhealthy를 구조도 위에 표시한다. |
| 16:38-16:47 | 팀 비교 | 서로의 구조도를 보고 빠진 부품을 찾는다. |
| 16:47-16:50 | 정리 | Day5 Cloud/DevOps 용어와 연결한다. |
