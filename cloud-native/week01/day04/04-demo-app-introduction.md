...
| 시간 | 단계 | 진행 |
|---|---|---|
| 12:00-12:08 | 앱 목적 | 시연 앱이 무엇을 보여주는지 확인한다. |
| 12:08-12:20 | 파일 구조 | `demo_app` 폴더를 살펴본다. |
| 12:20-12:35 | 주요 경로 | `/`, `/api/products`, `/health`, `/static/style.css`를 구분한다. |
| 12:35-12:45 | 실행 준비 | Python과 현재 폴더를 확인한다. |
| 12:45-12:50 | 오후 예고 | 실패 모드를 어떤 순서로 볼지 정리한다. |
