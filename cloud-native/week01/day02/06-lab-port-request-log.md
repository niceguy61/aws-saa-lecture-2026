...
| 시간 | 단계 | 진행 |
|---|---|---|
| 15:00-15:08 | 서버 재실행 | 5교시 앱을 다시 실행한다. |
| 15:08-15:20 | 정상 경로 요청 | `/`, `/health`, `/api/time`을 요청한다. |
| 15:20-15:32 | 없는 경로 요청 | 404 응답과 로그를 확인한다. |
| 15:32-15:42 | 포트 변경 | 환경 변수로 포트를 바꿔 실행한다. |
| 15:42-15:50 | 관찰 정리 | 화면, 응답, 로그를 표로 정리한다. |
