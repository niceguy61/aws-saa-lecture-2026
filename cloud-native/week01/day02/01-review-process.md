...
| 시간 | 단계 | 진행 |
|---|---|---|
| 09:00-09:08 | 전날 복습 | Day1의 Docker, Kubernetes, AWS, AI 흐름을 다시 연결한다. |
| 09:08-09:18 | 프로그램과 프로세스 | 파일로 있는 프로그램과 실행 중인 프로세스를 구분한다. |
| 09:18-09:30 | 왜 프로세스가 중요한가 | 서버 프로그램이 계속 실행되며 요청을 기다리는 구조를 이해한다. |
| 09:30-09:42 | 업계 흐름 | 한 서버에서 여러 프로세스를 직접 관리하던 방식에서 컨테이너 운영으로 넘어간 이유를 본다. |
| 09:42-09:50 | 정리 활동 | “앱이 실행된다”를 내 말로 다시 쓴다. |
