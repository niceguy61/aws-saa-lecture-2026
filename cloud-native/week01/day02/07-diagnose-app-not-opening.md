...
| 시간 | 단계 | 진행 |
|---|---|---|
| 16:00-16:08 | 진단 기준 | 화면, 주소, 서버 로그를 함께 본다는 기준을 세운다. |
| 16:08-16:20 | 서버 미실행 | 프로세스가 없을 때 브라우저가 어떻게 보이는지 확인한다. |
| 16:20-16:32 | 포트 착각 | 서버는 8080인데 브라우저는 8000으로 가는 상황을 본다. |
| 16:32-16:42 | 경로 오류 | 서버는 살아 있지만 없는 경로를 요청하는 상황을 본다. |
| 16:42-16:50 | 질문 정리 | 증상, 시도한 것, 궁금한 것을 정리한다. |
