...
| 시간 | 단계 | 진행 |
|---|---|---|
| 15:00-15:08 | 역할 분담 | 드라이버, 기록자, 그림 담당, 발표자를 정한다. |
| 15:08-15:25 | 정상 흐름 작성 | 코드 변경에서 health check까지를 만든다. |
| 15:25-15:38 | 실패 흐름 작성 | 실패 증상과 원인 후보를 추가한다. |
| 15:38-15:47 | 롤백/복구 작성 | 되돌리기 또는 다음 조치를 적는다. |
| 15:47-15:50 | 발표 준비 | 1분 설명으로 줄인다. |
