...
| 시간 | 단계 | 진행 |
|---|---|---|
| 10:00-10:08 | 출발 질문 | 서버를 직접 사야 한다면 무엇이 어려울지 생각한다. |
| 10:08-10:20 | Cloud가 생긴 배경 | 물리 서버, VM, Cloud로 이어진 흐름을 본다. |
| 10:20-10:35 | 기본 용어 | Region, account, VM, container, managed service를 구분한다. |
| 10:35-10:45 | 선택 기준 | 직접 운영과 관리형 서비스의 차이를 본다. |
| 10:45-10:50 | 정리 | Day5 배포 이야기와 연결한다. |
