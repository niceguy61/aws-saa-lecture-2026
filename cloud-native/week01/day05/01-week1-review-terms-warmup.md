...
| 시간 | 단계 | 진행 |
|---|---|---|
| 09:00-09:08 | 출발 질문 | 1주차에서 가장 자주 본 단어를 떠올린다. |
| 09:08-09:22 | 핵심 용어 복습 | 프로세스, 포트, 로그, 설정, health를 다시 말한다. |
| 09:22-09:35 | 실행과 운영 | 앱이 켜지는 것과 운영되는 것의 차이를 본다. |
| 09:35-09:45 | 연결 지도 | Docker, Kubernetes, Cloud, DevOps가 어디에 붙는지 본다. |
| 09:45-09:50 | 정리 | 오늘 팀 미션의 기준을 확인한다. |
...
다음 시간에는 Cloud를 자격증 암기식으로 외우지 않고, “왜 서버를 사지 않고 빌리게 되었는가”라는 변화의 흐름으로 본다.
