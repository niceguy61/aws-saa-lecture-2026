...
| 시간 | 단계 | 진행 |
|---|---|---|
| 11:00-11:08 | 출발 질문 | 코드 저장이 곧 배포인지 생각한다. |
| 11:08-11:22 | 배포 흐름 | 코드 변경에서 실행 중인 서비스까지의 단계를 본다. |
| 11:22-11:35 | 릴리스와 롤백 | 사용자 공개와 되돌리기 개념을 구분한다. |
| 11:35-11:45 | 실패 사례 | 설정 누락, 포트 문제, 데이터 문제를 배포 이야기로 바꾼다. |
| 11:45-11:50 | 정리 | 오후 팀 미션의 이야기 구조를 준비한다. |
