...
| 시간 | 단계 | 진행 |
|---|---|---|
| 12:00-12:08 | 출발 질문 | 개발팀과 운영팀이 서로 모르면 어떤 일이 생길지 생각한다. |
| 12:08-12:22 | DevOps 배경 | 수동 배포와 부서 분리에서 생긴 문제를 본다. |
| 12:22-12:35 | 피드백 루프 | 코드, 빌드, 배포, 관찰, 개선 흐름을 본다. |
| 12:35-12:45 | 반복 가능성 | 문서보다 자동화가 중요한 이유를 본다. |
| 12:45-12:50 | 정리 | 오후 팀 미션의 평가 기준을 확인한다. |
