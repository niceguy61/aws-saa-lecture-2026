...
class LectureGenerator:
    ...
    def generate_daily_lecture(
        ...
        for attempt in range(max_retries + 1):
            ...
            validation_result = self.validation_agent.validate_lecture(week, day, day_dir)
            ...
            if attempt < max_retries:
                ...
                # 피드백 생성
                feedback = self.validation_agent.generate_feedback_for_regeneration(validation_result)
                ...
                print(f"📂 Files saved to: {day_dir}")
                print(f"{'='*80}\n")
                return saved_files
