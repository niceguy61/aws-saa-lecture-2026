...
![고객 사례 삽화 - S3 스토리지 클래스 선택](../../assets/scenario_image/w4d3s1.png)
...
- IA/Glacier 계열은 “저장 단가”만 보고 고르면 함정이 된다. 문장에 “가끔이라도 꺼내본다”, “복구/조회가 필요하다”가 있으면 **복구 시간/복구 비용**까지 같이 고려해야 한다.
- One Zone-IA는 더 저렴할 수 있지만, **AZ 내구/가용성 요구**가 강하면 오답 후보가 된다(“중요 데이터/DR” 신호가 붙으면 특히 조심).
- Intelligent-Tiering은 “패턴 예측 불가”일 때 강하지만, 모든 상황에서 무조건 정답이 되진 않는다. “복구 시간 제약”이 강하면 목적에 맞는 클래스로 먼저 좁히는 편이 자연스럽다.
