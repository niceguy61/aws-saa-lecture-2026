# Day NN - Theory Index (서비스 분리형)

> 이 문서는 Day 이론 “인덱스”다. 상세 이론은 `theory/*.md` 서비스별 문서로 분리한다.
...
- TODO: `[Service A](theory/10-service-a.md)`
- TODO: `[Service B](theory/20-service-b.md)`
