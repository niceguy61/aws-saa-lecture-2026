...
- [CloudTrail: API 활동의 근거 자료](theory/10-cloudtrail.md)
- [AWS Config: 구성 변화와 준수(Compliance) 관점](theory/20-config.md)
- [Detection services: GuardDuty / Security Hub / Inspector](theory/30-detection-services.md)
